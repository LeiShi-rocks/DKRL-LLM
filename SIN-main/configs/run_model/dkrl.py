...
def add_params(parser):
    # -------------------------------------------------- Data --------------------------------------------------
    parser.add_argument(
        "--dim_covariates", type=int, default=200, help="Dimensions of covariates"
    )
    parser.add_argument(
        "--dim_node_features", type=int, default=384, help="Dimensions of node features"
    )
    parser.add_argument(
        "--num_treatments", type=int, default=50, help="Number of available treatments"
    )
    ...
    parser.add_argument("--num_covariates_layer", type=int, default=4)
    # Hidden layer dimensions
    parser.add_argument("--dim_hidden_covariates", type=int, default=200) #200
    parser.add_argument("--dim_hidden_treatment", type=int, default=100) #100
    # Output layer dimensions
    parser.add_argument("--dim_output_covariates", type=int, default=100) #100
    parser.add_argument("--dim_output_treatment", type=int, default=100) #100
    ...
    parser.add_argument("--gnn_num_relations", type=int, default=1)
    ...
    parser.add_argument("--dim_output", type=int, default=50)
    parser.add_argument(
